  ...
  <b-card no-body>
    <b-card-header>
      ...
      <div>
        ...
        <b-card-sub-title>各類商品的銷售量</b-card-sub-title>
      </div>
      <!--/ title and subtitle -->
  ...
  methods: {
    ...
    async loadRecord() {
      ...
      await useJwt.axiosIns.post('http://127.0.0.1:8080/admin/getAnalysisRecord', querystring.stringify({
        ...
        this.$refs.sellChart.updateSeries(seriesArr, false, true)
        this.$refs.sellChart.updateOptions(this.data.chartOptions, false, true)
        this.$forceUpdate()
      })
    },
